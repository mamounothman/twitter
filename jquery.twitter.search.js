...
;(function($) {
	...
	$.fn.twitterSearch.defaults = {
		...
		css: {
			...
			bird:  { width: '50px', height: '20px', position: 'absolute', left: '-20px', top: '-10px', border: 'none' },
			...
			title: { backgroundColor: '#C2CFF1', margin: 0, padding: '0 0 5px 0', textAlign: 'center', fontWeight: 'bold', fontSize: 'large' },
